...
export const translations: Translations = {
	strings: {
		...
		'Room "${roomid}" not found.': 'Room "${roomid}" not found.',
		'Can\'t delete poll at slot ${slotString} - "${slotString}" is not a number.': 'Can\'t delete poll at slot ${slotString} - "${slotString}" is not a number.',
