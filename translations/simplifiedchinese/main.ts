...
export const translations: Translations = {
	...
	strings: {
		...
		'Your status has been set to: ${target}.": "您的状态已设置为: ${target}.", "You are now marked as busy.': 'Your status has been set to: ${target}.": "您的状态已设置为: ${target}.", "You are now marked as busy.',
