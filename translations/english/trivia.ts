...
export const translations: Translations = {
	strings: {
		...
		'Mode: ${this.game.mode} | Category: ${this.game.category} | Score cap: ${this.getCap() || "Infinite"}<br />': 'Mode: ${this.game.mode} | Category: ${this.game.category} | Score cap: ${this.getCap() || "Infinite"}<br />',
		"Enter /trivia join to sign up for the trivia game.": "",
		'Mode: ${this.game.mode} | Category: ${this.game.category} | Score cap: ${this.getCap() || "Infinite"}': 'Mode: ${this.game.mode} | Category: ${this.game.category} | Score cap: ${this.getCap() || "Infinite"}',
		...
		'"${mode}" is an invalid mode.': '"${mode}" is an invalid mode.',
		'"${category}" is an invalid category.': '"${category}" is an invalid category.',
		'"${length}" is an invalid game length.': '"${length}" is an invalid game length.',
		...
		'There are not enough questions under the category "${ALL_CATEGORIES[category]}" to finish a trivia game.': 'There are not enough questions under the category "${ALL_CATEGORIES[category]}" to finish a trivia game.',
		"You are now signed up for this game!": "",
		'The user "${target}" does not exist.': 'The user "${target}" does not exist.',
		"You have left the current game of Trivia.": "",
		"No valid answer was entered.": "",
		'You have selected "${answer}" as your answer.': 'You have selected "${answer}" as your answer.',
		...
		'Mode: ${game.game.mode} | Category: ${game.game.category} | Score cap: ${game.getCap() || "Infinite"}': 'Mode: ${game.game.mode} | Category: ${game.game.category} | Score cap: ${game.getCap() || "Infinite"}',
		...
		'Invalid arguments specified in "${param}". View /trivia help for more information.': 'Invalid arguments specified in "${param}". View /trivia help for more information.',
		...
		'Question "${param[1].trim()}" is too long! It must remain under ${MAX_QUESTION_LENGTH} characters.': 'Question "${param[1].trim()}" is too long! It must remain under ${MAX_QUESTION_LENGTH} characters.',
		'Question "${question}" is already in the trivia database.': 'Question "${question}" is already in the trivia database.',
		...
		'The user "${playerID}" has already played their round of Mastermind.': 'The user "${playerID}" has already played their round of Mastermind.',
